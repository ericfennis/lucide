...
// While searching, "Popularity" keeps Algolia's relevance order (popularity is part of
// the index ranking). The other sort options re-sort the matching icons locally.
